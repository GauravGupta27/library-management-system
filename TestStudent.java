						    	    			 ...
						    	    			 case  STUDENTACCOUNT: System.out.println("ENTER THE ROLLNO OF STUDENT");
						    	    			                       int rollno=sc.nextInt();
										                                ...
										                                if(rollno==bookissued2.getStudent().getId()) {
										                        	      System.out.println("BookId: "+ bookissued2.getId()+ "  Student Name:"+bookissued2.getStudent().getName() +  "  Student EmailId: "+bookissued2.getStudent().getEmail() +" bookissued date : "+bookissued2.getIssueddate()+"  bookreturn date:"+bookissued2.getReturndate()+  "  fine: "+bookissued2.getStudent().getFine());
											                             } 
					    	     ...
					    	     case SUGGESTION: System.out.println(" WRITE THE SUGGESTION");
		    	    			  ...
		    	    			  case STUDENTACCOUNT: String hql4="SELECT Bi FROM BookIssued Bi ";
		    	                                       ...
		    	                                       if(registeredemailid.equals(bookissued1.getStudent().getEmail())) {
		    	                        	                System.out.println("BookId: "+ bookissued1.getId()+  "BookIssued Date :"+bookissued1.getIssueddate()+" BookReturn Date:"+bookissued1.getReturndate()+ " Fine:"+bookissued1.getStudent().getFine());
					                                  } 
